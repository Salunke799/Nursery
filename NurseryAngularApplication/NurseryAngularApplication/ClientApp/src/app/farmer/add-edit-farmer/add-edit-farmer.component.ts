...
import { Farmer } from '../../services/service-file/farmer';

@Component({
  selector: 'add-edit-farmer',
  templateUrl: './add-edit-farmer.component.html',
  styleUrls: ['./add-edit-farmer.component.css']
})
export class AddEditFarmerComponent implements OnInit {
  nursery: any;
  ...
  addFarmer() {
    debugger
    this.dataService.addEmployee(this.farmer).subscribe(res => {
